...
#define IROBSTACLE_MOVE_OBS_FRONT_ANGLE		(MILLIRAD_PI * 3/6)
#define IROBSTACLE_MOVE_OBS_FRONT_X_ANGLE	(MILLIRAD_PI * 2/6)
#define IROBSTACLE_MOVE_OBS_X_ANGLE			(MILLIRAD_PI * 1/6)
