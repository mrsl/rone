...
#define IROBSTACLE_MOVE_OBS_FRONT_ANGLE		MILLIRAD_PI
#define IROBSTACLE_MOVE_OBS_FRONT_X_ANGLE	(2 * MILLIRAD_PI / 3)
#define IROBSTACLE_MOVE_OBS_X_ANGLE			(1 * MILLIRAD_PI / 3)


#define BUMPMOVE_OBS_FRONT_ANGLE		(MILLIRAD_PI / 3)
